...
namespace Microsoft.MixedReality.GraphicsTools
{
    ...
    public class GraphicsToolsStandardShaderBehaviour : BaseShaderBehaviour
    {
        ...
        private static int _AlbedoAlphaModeID = Shader.PropertyToID("_AlbedoAlphaMode");
        [HideInInspector] public float _AlbedoAssignedAtRuntime = 0f;
        private static int _AlbedoAssignedAtRuntimeID = Shader.PropertyToID("_AlbedoAssignedAtRuntime");
        ...
        private static int _EnableChannelMapID = Shader.PropertyToID("_EnableChannelMap");
        [HideInInspector] public Texture2D _ChannelMap = null;
        private static int _ChannelMapID = Shader.PropertyToID("_ChannelMap");
        [HideInInspector] public float _EnableNormalMap = 0f;
        private static int _EnableNormalMapID = Shader.PropertyToID("_EnableNormalMap");
        [HideInInspector] public Texture2D _NormalMap = null;
        private static int _NormalMapID = Shader.PropertyToID("_NormalMap");
        [HideInInspector] public float _NormalMapScale = 1f;
        private static int _NormalMapScaleID = Shader.PropertyToID("_NormalMapScale");
        [HideInInspector] public float _EnableEmission = 0f;
        private static int _EnableEmissionID = Shader.PropertyToID("_EnableEmission");
        [HideInInspector] public Color _EmissiveColor = Color.white;
        private static int _EmissiveColorID = Shader.PropertyToID("_EmissiveColor");
        [HideInInspector] public float _EnableTriplanarMapping = 0f;
        private static int _EnableTriplanarMappingID = Shader.PropertyToID("_EnableTriplanarMapping");
        [HideInInspector] public float _EnableSSAA = 0f;
        private static int _EnableSSAAID = Shader.PropertyToID("_EnableSSAA");
        [HideInInspector, Range(-5f, 0f)] public float _MipmapBias = -2f;
        private static int _MipmapBiasID = Shader.PropertyToID("_MipmapBias");
        [HideInInspector] public float _EnableLocalSpaceTriplanarMapping = 0f;
        private static int _EnableLocalSpaceTriplanarMappingID = Shader.PropertyToID("_EnableLocalSpaceTriplanarMapping");
        [HideInInspector, Range(1f, 16f)] public float _TriplanarMappingBlendSharpness = 4f;
        private static int _TriplanarMappingBlendSharpnessID = Shader.PropertyToID("_TriplanarMappingBlendSharpness");
        [HideInInspector] public float _DirectionalLight = 1f;
        private static int _DirectionalLightID = Shader.PropertyToID("_DirectionalLight");
        [HideInInspector] public float _SpecularHighlights = 1f;
        private static int _SpecularHighlightsID = Shader.PropertyToID("_SpecularHighlights");
        [HideInInspector] public float _SphericalHarmonics = 0f;
        private static int _SphericalHarmonicsID = Shader.PropertyToID("_SphericalHarmonics");
        [HideInInspector] public float _Reflections = 0f;
        private static int _ReflectionsID = Shader.PropertyToID("_Reflections");
        [HideInInspector] public float _Refraction = 0f;
        private static int _RefractionID = Shader.PropertyToID("_Refraction");
        [HideInInspector, Range(0f, 3f)] public float _RefractiveIndex = 0f;
        private static int _RefractiveIndexID = Shader.PropertyToID("_RefractiveIndex");
        [HideInInspector] public float _RimLight = 0f;
        private static int _RimLightID = Shader.PropertyToID("_RimLight");
        [HideInInspector] public Color _RimColor = Color.white;
        private static int _RimColorID = Shader.PropertyToID("_RimColor");
        [HideInInspector, Range(0f, 8f)] public float _RimPower = 0.25f;
        private static int _RimPowerID = Shader.PropertyToID("_RimPower");
        [HideInInspector] public float _VertexColors = 0f;
        private static int _VertexColorsID = Shader.PropertyToID("_VertexColors");
        [HideInInspector] public float _VertexExtrusion = 0f;
        private static int _VertexExtrusionID = Shader.PropertyToID("_VertexExtrusion");
        [HideInInspector] public float _VertexExtrusionValue = 0f;
        private static int _VertexExtrusionValueID = Shader.PropertyToID("_VertexExtrusionValue");
        [HideInInspector] public float _VertexExtrusionSmoothNormals = 0f;
        private static int _VertexExtrusionSmoothNormalsID = Shader.PropertyToID("_VertexExtrusionSmoothNormals");
        [HideInInspector, Range(0f, 10f)] public float _BlendedClippingWidth = 1f;
        private static int _BlendedClippingWidthID = Shader.PropertyToID("_BlendedClippingWidth");
        [HideInInspector] public float _ClippingBorder = 0f;
        private static int _ClippingBorderID = Shader.PropertyToID("_ClippingBorder");
        [HideInInspector, Range(0f, 1f)] public float _ClippingBorderWidth = 0.025f;
        private static int _ClippingBorderWidthID = Shader.PropertyToID("_ClippingBorderWidth");
        [HideInInspector] public Color _ClippingBorderColor = Color.white;
        private static int _ClippingBorderColorID = Shader.PropertyToID("_ClippingBorderColor");
        [HideInInspector] public float _NearPlaneFade = 0f;
        private static int _NearPlaneFadeID = Shader.PropertyToID("_NearPlaneFade");
        [HideInInspector] public float _NearLightFade = 0f;
        private static int _NearLightFadeID = Shader.PropertyToID("_NearLightFade");
        [HideInInspector, Range(0f, 10f)] public float _FadeBeginDistance = 0.85f;
        private static int _FadeBeginDistanceID = Shader.PropertyToID("_FadeBeginDistance");
        [HideInInspector, Range(0f, 10f)] public float _FadeCompleteDistance = 0.5f;
        private static int _FadeCompleteDistanceID = Shader.PropertyToID("_FadeCompleteDistance");
        [HideInInspector, Range(0f, 1f)] public float _FadeMinValue = 0f;
        private static int _FadeMinValueID = Shader.PropertyToID("_FadeMinValue");
        [HideInInspector] public float _HoverLight = 1f;
        private static int _HoverLightID = Shader.PropertyToID("_HoverLight");
        [HideInInspector] public float _EnableHoverColorOverride = 0f;
        private static int _EnableHoverColorOverrideID = Shader.PropertyToID("_EnableHoverColorOverride");
        [HideInInspector] public Color _HoverColorOverride = Color.white;
        private static int _HoverColorOverrideID = Shader.PropertyToID("_HoverColorOverride");
        [HideInInspector] public float _ProximityLight = 0f;
        private static int _ProximityLightID = Shader.PropertyToID("_ProximityLight");
        [HideInInspector] public float _EnableProximityLightColorOverride = 0f;
        private static int _EnableProximityLightColorOverrideID = Shader.PropertyToID("_EnableProximityLightColorOverride");
        [HideInInspector] public Color _ProximityLightCenterColorOverride = Color.white;
        private static int _ProximityLightCenterColorOverrideID = Shader.PropertyToID("_ProximityLightCenterColorOverride");
        [HideInInspector] public Color _ProximityLightMiddleColorOverride = Color.white;
        private static int _ProximityLightMiddleColorOverrideID = Shader.PropertyToID("_ProximityLightMiddleColorOverride");
        [HideInInspector] public Color _ProximityLightOuterColorOverride = Color.white;
        private static int _ProximityLightOuterColorOverrideID = Shader.PropertyToID("_ProximityLightOuterColorOverride");
        [HideInInspector] public float _ProximityLightSubtractive = 0f;
        private static int _ProximityLightSubtractiveID = Shader.PropertyToID("_ProximityLightSubtractive");
        [HideInInspector] public float _ProximityLightTwoSided = 0f;
        private static int _ProximityLightTwoSidedID = Shader.PropertyToID("_ProximityLightTwoSided");
        [HideInInspector, Range(0f, 1f)] public float _FluentLightIntensity = 1f;
        private static int _FluentLightIntensityID = Shader.PropertyToID("_FluentLightIntensity");
        [HideInInspector] public float _RoundCorners = 0f;
        private static int _RoundCornersID = Shader.PropertyToID("_RoundCorners");
        [HideInInspector, Range(0f, 0.5f)] public float _RoundCornerRadius = 0.25f;
        private static int _RoundCornerRadiusID = Shader.PropertyToID("_RoundCornerRadius");
        [HideInInspector, Range(0f, 0.5f)] public float _RoundCornerMargin = 0.01f;
        private static int _RoundCornerMarginID = Shader.PropertyToID("_RoundCornerMargin");
        [HideInInspector] public float _IndependentCorners = 0f;
        private static int _IndependentCornersID = Shader.PropertyToID("_IndependentCorners");
        [HideInInspector] public Vector3 _RoundCornersRadius = Vector3.zero;
        private static int _RoundCornersRadiusID = Shader.PropertyToID("_RoundCornersRadius");
        [HideInInspector] public float _RoundCornersHideInterior = 0f;
        private static int _RoundCornersHideInteriorID = Shader.PropertyToID("_RoundCornersHideInterior");
        [HideInInspector] public float _BorderLight = 0f;
        private static int _BorderLightID = Shader.PropertyToID("_BorderLight");
        [HideInInspector] public float _BorderLightReplacesAlbedo = 0f;
        private static int _BorderLightReplacesAlbedoID = Shader.PropertyToID("_BorderLightReplacesAlbedo");
        [HideInInspector] public float _BorderLightOpaque = 0f;
        private static int _BorderLightOpaqueID = Shader.PropertyToID("_BorderLightOpaque");
        [HideInInspector, Range(0f, 1f)] public float _BorderWidth = 0.1f;
        private static int _BorderWidthID = Shader.PropertyToID("_BorderWidth");
        [HideInInspector] public float _BorderColorMode = 0f;
        private static int _BorderColorModeID = Shader.PropertyToID("_BorderColorMode");
        [HideInInspector, Range(0f, 1f)] public float _BorderMinValue = 0.1f;
        private static int _BorderMinValueID = Shader.PropertyToID("_BorderMinValue");
        [HideInInspector] public Color _BorderColor = Color.white;
        private static int _BorderColorID = Shader.PropertyToID("_BorderColor");
        [HideInInspector] public float _EdgeSmoothingValue = 0.002f;
        private static int _EdgeSmoothingValueID = Shader.PropertyToID("_EdgeSmoothingValue");
        [HideInInspector, Range(0f, 1f)] public float _BorderLightOpaqueAlpha = 1f;
        private static int _BorderLightOpaqueAlphaID = Shader.PropertyToID("_BorderLightOpaqueAlpha");
        [HideInInspector] public float _InnerGlow = 0f;
        private static int _InnerGlowID = Shader.PropertyToID("_InnerGlow");
        [HideInInspector] public Color _InnerGlowColor = Color.white;
        private static int _InnerGlowColorID = Shader.PropertyToID("_InnerGlowColor");
        [HideInInspector, Range(2f, 32f)] public float _InnerGlowPower = 4f;
        private static int _InnerGlowPowerID = Shader.PropertyToID("_InnerGlowPower");
        [HideInInspector] public float _GradientMode = 0f;
        private static int _GradientModeID = Shader.PropertyToID("_GradientMode");
        [HideInInspector] public Texture2D _IridescentSpectrumMap = null;
        private static int _IridescentSpectrumMapID = Shader.PropertyToID("_IridescentSpectrumMap");
        [HideInInspector, Range(0f, 1f)] public float _IridescenceIntensity = 0.5f;
        private static int _IridescenceIntensityID = Shader.PropertyToID("_IridescenceIntensity");
        [HideInInspector, Range(0f, 1f)] public float _IridescenceThreshold = 0.05f;
        private static int _IridescenceThresholdID = Shader.PropertyToID("_IridescenceThreshold");
        [HideInInspector, Range(-0.78f, 0.78f)] public float _IridescenceAngle = -0.78f;
        private static int _IridescenceAngleID = Shader.PropertyToID("_IridescenceAngle");
        [HideInInspector, Range(0f, 360f)] public float _GradientAngle = 180f;
        private static int _GradientAngleID = Shader.PropertyToID("_GradientAngle");
        [HideInInspector] public Color _GradientColor0 = Color.white;
        private static int _GradientColor0ID = Shader.PropertyToID("_GradientColor0");
        [HideInInspector] public Color _GradientColor1 = Color.white;
        private static int _GradientColor1ID = Shader.PropertyToID("_GradientColor1");
        [HideInInspector] public Color _GradientColor2 = Color.white;
        private static int _GradientColor2ID = Shader.PropertyToID("_GradientColor2");
        [HideInInspector] public Color _GradientColor3 = Color.white;
        private static int _GradientColor3ID = Shader.PropertyToID("_GradientColor3");
        [HideInInspector] public Color _GradientColor4 = Color.white;
        private static int _GradientColor4ID = Shader.PropertyToID("_GradientColor4");
        [HideInInspector] public float _EnvironmentColoring = 0f;
        private static int _EnvironmentColoringID = Shader.PropertyToID("_EnvironmentColoring");
        [HideInInspector, Range(0f, 3f)] public float _EnvironmentColorThreshold = 1.5f;
        private static int _EnvironmentColorThresholdID = Shader.PropertyToID("_EnvironmentColorThreshold");
        [HideInInspector, Range(0f, 1f)] public float _EnvironmentColorIntensity = 0.5f;
        private static int _EnvironmentColorIntensityID = Shader.PropertyToID("_EnvironmentColorIntensity");
        [HideInInspector] public Color _EnvironmentColorX = Color.white;
        private static int _EnvironmentColorXID = Shader.PropertyToID("_EnvironmentColorX");
        [HideInInspector] public Color _EnvironmentColorY = Color.white;
        private static int _EnvironmentColorYID = Shader.PropertyToID("_EnvironmentColorY");
        [HideInInspector] public Color _EnvironmentColorZ = Color.white;
        private static int _EnvironmentColorZID = Shader.PropertyToID("_EnvironmentColorZ");
        [HideInInspector] public float _Mode = 0f;
        private static int _ModeID = Shader.PropertyToID("_Mode");
        [HideInInspector] public float _CustomMode = 0f;
        private static int _CustomModeID = Shader.PropertyToID("_CustomMode");
        [HideInInspector] public float _SrcBlend = 1f;
        private static int _SrcBlendID = Shader.PropertyToID("_SrcBlend");
        [HideInInspector] public float _DstBlend = 0f;
        private static int _DstBlendID = Shader.PropertyToID("_DstBlend");
        ...
        private static int _ZTestID = Shader.PropertyToID("_ZTest");
        [HideInInspector] public float _ZWrite = 1f;
        private static int _ZWriteID = Shader.PropertyToID("_ZWrite");
        [HideInInspector] public float _ZOffsetFactor = 0f;
        private static int _ZOffsetFactorID = Shader.PropertyToID("_ZOffsetFactor");
        [HideInInspector] public float _ZOffsetUnits = 0f;
        private static int _ZOffsetUnitsID = Shader.PropertyToID("_ZOffsetUnits");
        [HideInInspector] public float _ColorWriteMask = 15f;
        private static int _ColorWriteMaskID = Shader.PropertyToID("_ColorWriteMask");
        [HideInInspector] public float _CullMode = 2f;
        private static int _CullModeID = Shader.PropertyToID("_CullMode");
        [HideInInspector, Range(-1f, 5000f)] public float _RenderQueueOverride = -1f;
        private static int _RenderQueueOverrideID = Shader.PropertyToID("_RenderQueueOverride");
        [HideInInspector] public float _UseWorldScale = 0f;
        private static int _UseWorldScaleID = Shader.PropertyToID("_UseWorldScale");
        [HideInInspector] public float _Stencil = 0f;
        private static int _StencilID = Shader.PropertyToID("_Stencil");
        [HideInInspector, Range(0f, 255f)] public float _StencilReference = 0f;
        private static int _StencilReferenceID = Shader.PropertyToID("_StencilReference");
        [HideInInspector] public float _StencilComparison = 0f;
        private static int _StencilComparisonID = Shader.PropertyToID("_StencilComparison");
        [HideInInspector] public float _StencilOperation = 0f;
        private static int _StencilOperationID = Shader.PropertyToID("_StencilOperation");
