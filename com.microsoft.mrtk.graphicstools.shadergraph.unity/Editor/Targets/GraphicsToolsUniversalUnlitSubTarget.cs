...
namespace UnityEditor.Rendering.Universal.ShaderGraph
{
    sealed class GraphicsToolsUniversalUnlitSubTarget : UniversalSubTarget, ILegacyTarget
    {
        ...
        public override void Setup(ref TargetSetupContext context)
        {
            ...
            // Process SubShaders
            context.AddSubShader(PostProcessSubShader(SubShaders.Unlit(target, target.renderType, target.renderQueue, target.disableBatching, overrideBlendAlpha, srcBlendAlpha, dstBlendAlpha)));
        ...
        {
            public static SubShaderDescriptor Unlit(UniversalTarget target, string renderType, string renderQueue, string disableBatchingTag, bool overrideBlendAlpha, Blend alphaSrc, Blend alphaDst)
            {
                ...
                result.passes.Add(UnlitPasses.Forward(target, UnlitKeywords.Forward, overrideBlendAlpha, alphaSrc, alphaDst));
        ...
        {
            public static PassDescriptor Forward(UniversalTarget target, KeywordCollection keywords, bool overrideBlendAlpha, Blend alphaSrc, Blend alphaDst)
            {
